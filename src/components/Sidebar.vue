<template>
  <div class="sidebar-container">
    ...
    <div class="sidebar-items">
      <router-link to="/main" class="sidebar-item home">
        <!-- Home SVG -->
        <svg
          width="24"
          height="22"
      ...
      <router-link class="sidebar-item chatroom" to="/chatroom">
        <!-- mail empty icon -->
        <svg
          v-if="!chatRoomTab"
          width="20"
      ...
      <router-link to="/setting" class="sidebar-item setting">
        <!-- Setting SVG -->
        <svg
          width="24"
          height="24"
